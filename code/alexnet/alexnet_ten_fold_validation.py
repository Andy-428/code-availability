...
if __name__ == "__main__":
    ...
    for fold, (train_idx, val_idx) in enumerate(kf.split(dataset.samples, targets)):
        ...
        model.load_state_dict(torch.load('/mnt/code/AlexNet/alexnet-owt-7be5be79.pth'))
    ...
    torch.save(avg_weights, '/mnt/code/AlexNet/alexnet_average_weights.pth')

    with open('/mnt/code/AlexNet/alexnet_training_results.pkl', 'wb') as f:
        pickle.dump({
    ...
    with open('/mnt/code/AlexNet/alexnet_final_results.txt', 'w') as f:
