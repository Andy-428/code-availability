...
if __name__ == "__main__":
    ...
    torch.save(avg_weights, '/mnt/code/VGG16/vgg16_average_weights.pth')

    with open('/mnt/code/VGG16/vgg16_training_results.pkl', 'wb') as f:
        pickle.dump({
    ...
    with open('/mnt/code/VGG16/vgg16_final_results.txt', 'w') as f:
