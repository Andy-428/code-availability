...
if __name__ == "__main__":
    ...
    torch.save(avg_weights, '/mnt/code/GoogLeNet/googlenet_average_weights.pth')

    with open('/mnt/code/GoogLeNet/googlenet_training_results.pkl', 'wb') as f:
        pickle.dump({
    ...
    with open('/mnt/code/GoogLeNet/googlenet_final_results.txt', 'w') as f:
