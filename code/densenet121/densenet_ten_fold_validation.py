...
if __name__ == "__main__":
    ...
    fold_results = {'Recall': [], 'Specificity': [], 'Precision': [], 'F1_Score': [], 'Accuracy': [], 'ROC_AUC': []}
    model_weights = []
    all_train_losses = []
    all_val_losses = []
    ...
    torch.save(avg_weights, '/mnt/code/DenseNet121/densenet_average_weights.pth')

    with open('/mnt/code/DenseNet121/densenet_training_results.pkl', 'wb') as f:
        pickle.dump({
    ...
    with open('/mnt/code/DenseNet121/densenet_final_results.txt', 'w') as f:
