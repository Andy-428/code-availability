...
if __name__ == "__main__":
    ...
    torch.save(avg_weights, '/mnt/code/ResNet34/resnet34_average_weights.pth')

    with open('/mnt/code/ResNet34/resnet34_training_results.pkl', 'wb') as f:
        pickle.dump({
    ...
    with open('/mnt/code/ResNet34/resnet34_final_results.txt', 'w') as f:
