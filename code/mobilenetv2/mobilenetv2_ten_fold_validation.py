...
if __name__ == "__main__":
    ...
    torch.save(avg_weights, '/mnt/code/MobileNetV2/mobilenetv2_average_weights.pth')

    with open('/mnt/code/MobileNetV2/mobilenetv2_training_results.pkl', 'wb') as f:
        pickle.dump({
    ...
    with open('/mnt/code/MobileNetV2/mobilenetv2_final_results.txt', 'w') as f:
