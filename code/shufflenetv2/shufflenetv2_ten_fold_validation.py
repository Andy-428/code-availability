...
if __name__ == "__main__":
    ...
    for fold, (train_idx, val_idx) in enumerate(kf.split(dataset.samples, targets)):
        ...
        model.load_state_dict(torch.load('/mnt/code/ShuffleNetV2/shufflenetv2_x2_0-8be3c8ee.pth'))
    ...
    torch.save(avg_weights, '/mnt/code/ShuffleNetV2/shufflenetv2_average_weights.pth')

    with open('/mnt/code/ShuffleNetV2/shufflenetv2_training_results.pkl', 'wb') as f:
        pickle.dump({
    ...
    with open('/mnt/code/ShuffleNetV2/shufflenetv2_final_results.txt', 'w') as f:
