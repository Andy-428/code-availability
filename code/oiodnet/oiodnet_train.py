...
from oiodnet import OIODNet, alexnet_pretrained_path, shufflenet_pretrained_path
...
if __name__ == "__main__":
    ...
    for fold, (train_idx, val_idx) in enumerate(kf.split(dataset.samples, targets)):
        ...
        # The parameters of the classifier layer remain trainable
        for param in model.fc.parameters():
            param.requires_grad = False

        # Cross entropy loss function with appropriate weight adjustment
    ...
    torch.save(avg_weights, f'/mnt/code/oiodnet/oiodnet_average_weights.pth')

    with open(f'/mnt/code/oiodnet/oiodnet_training_results.pkl', 'wb') as f:
        pickle.dump({
    ...
    with open(f'/mnt/code/oiodnet/oiodnet_final_results.txt', 'w') as f:
